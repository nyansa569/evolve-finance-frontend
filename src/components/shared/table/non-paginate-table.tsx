...
interface DataTableProps<TData, TValue> {
  ...
  // FIXME: handle table date operation that affect the api calls
  mode?: "single" | "range";
...
export function DataTableUnpaginate<TData, TValue>({
  data,
  title,
  columns,
  inputKey,
  ...
  const table = useReactTable({
    ...
    // we don't need this because we are doing manual pagination from the server
  ...
  return (
    ...
    >
      ...
      <Table className={cn("min-w-[500px] max-h-40 overflow-auto ", tableClassName)}>
        <TableHeader>
